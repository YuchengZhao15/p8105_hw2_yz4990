...
create a reader-friendly table using pivot\_wider()
    ...
    ## `summarise()` has grouped output by 'baker'. You can override using the
    ## `.groups` argument.
...
The predicable overall winner would be Richard, as he has the maximum
number of being “WINNER” or “STAR BAKER.” The surprisees would be the
bakers who have the least number of being “WINNER” or “STAR BAKER,” such
as Benjamina, Chetna, and Dan.
